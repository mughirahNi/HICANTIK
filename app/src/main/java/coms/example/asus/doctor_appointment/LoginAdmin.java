...
public class LoginAdmin extends AppCompatActivity {
    ...
    public void Checlogin(String email, String password, String repassword) {
        if (checkNetworkConnection()) {
            ...
            progressDialog.show();
            StringRequest stringRequest = new StringRequest(Request.Method.POST, DbContact.SERVER_LOGINADMIN_URL,
            ...
            VolleyConnection.getInstance(LoginAdmin.this).addToRequestQue(stringRequest);
